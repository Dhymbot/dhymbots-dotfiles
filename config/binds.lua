...
-- BRO SOY GILIPOLLAS YA ESTABA ESTE TOGGLE JAJAJA hl.bind(mainMod .. " + CONTROL + P",           hl.dsp.window.float({ action = "toggle" }))
...
hl.bind(mainMod .. " + B",          hl.dsp.exec_cmd(launchPrefix .. BADLION))
hl.bind(mainMod .. " + SHIFT + B",  hl.dsp.exec_cmd(launchPrefix .. PRISM))
hl.bind(mainMod .. " + N",          hl.dsp.exec_cmd(launchPrefix .. SPOTIFY))
...
---- OBS CONFIG ----
--------------------
hl.bind("CTRL + KP_End",            hl.dsp.exec_cmd('~/.config/hypr/scripts/obs-scene.py "EnJuego"'))
hl.bind("CONTROL + KP_Down",        hl.dsp.exec_cmd('~/.config/hypr/scripts/obs-scene.py "Inicio"'))
hl.bind("CONTROL + KP_Next",        hl.dsp.exec_cmd('~/.config/hypr/scripts/obs-scene.py "Cierre"'))
hl.bind("CONTROL + KP_Insert",      hl.dsp.exec_cmd("~/.config/hypr/scripts/obs-mute.py Música"))
